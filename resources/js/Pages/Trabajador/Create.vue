...
const props = defineProps({
    embarcaciones: Array, // Asegúrate de que embarcaciones se pase desde el servidor
});
const form = useForm({
    nombre: '',
    apellido: '', 
...
const submit = () => {
  form.post(route('trabajador.store'), {
    ...
    onError: (errors) => {
      // Aquí puedes hacer algo, como mostrar una alerta o un mensaje
      alert('No se pudo crear el trabajador. Por favor revisa los errores en el formulario.');
      // Los errores están en form.errors automáticamente, los muestras en cada campo
      console.log(errors);
    }
  });
};
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select id="embarcacion_id" v-model="form.embarcacion_id" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 bg-white text-black">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="telefono" v-model="form.telefono" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 bg-white text-black" placeholder="+569..."/>
                            </div>
                        </div>
                    </div>
