...
<template>
    ...
    <div class="bg-gradient-to-r from-blue-500 to-purple-600 text-white min-h-screen">
        ...
        <div class="relative flex flex-col items-center justify-center h-full text-center px-6">
            <div class="max-w-7xl w-full px-6 lg:px-16">
                <!-- Header -->
                <header class="grid grid-cols-1 lg:grid-cols-3 gap-6 py-12">
                    ...
                    <nav v-if="canLogin" class="flex justify-end space-x-4">
                        <Link
                            ...
                            class="px-4 py-2 rounded-lg bg-white text-black hover:bg-gray-200 transition-all"
                        >
                            Dashboard
                        </Link>
                ...
                <main class="text-center">
                    ...
                    <p class="text-xl mb-6">Version: {{ laravelVersion }} | PHP: {{ phpVersion }}</p>
                </main>
            </div>
        </div>
    </div>
...
<style scoped>
/* Tailwind custom classes for responsiveness and better styling */
</style>
